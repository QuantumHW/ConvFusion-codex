...
export declare const OUTPUT_TYPES: readonly OutputType[];
/** 预留类型（§6 允许但不实现）。 */
export declare const RESERVED_OUTPUT_TYPES: readonly string[];
 ...
 */
export declare const OUTPUT_DIRS: Record<OutputType, string>;
/**
 * 一个 Output 的来源声明。
 *
...
export declare const OUTPUT_STATUSES: readonly OutputStatus[];
...
/** 版本快照目录（与各类型目录平级）。 */
export declare const OUTPUT_VERSIONS_DIR = "outputs/.history";
/**
 * 类型 → id 前缀（**单数**）。
 *
 ...
 */
export declare const OUTPUT_ID_PREFIX: Record<OutputType, string>;
/**
 ...
 */
export declare const OUTPUT_MAIN_FILE: Record<OutputType, string>;
/** 每个成果目录内的标准附属文件（§11–§13）。 */
export declare const OUTPUT_AUX_FILES: Record<OutputType, readonly string[]>;
/** 每个成果目录内的标准附属**目录**（§13：slides 有 assets/）。 */
export declare const OUTPUT_AUX_DIRS: Record<OutputType, readonly string[]>;
/** 版本快照条目。 */
...
//# sourceMappingURL=output-data.d.ts.map