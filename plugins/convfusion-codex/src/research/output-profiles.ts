...
const PAPER: OutputProfile = {
  type: 'paper',
  name: 'Research Paper',
  audience: 'Peer reviewers and the research community of the target venue.',
  purpose:
    'Communicate the research so that a reader can judge the claim, reproduce the evidence, and place it against prior work.',
  structure: [
    'Abstract',
    'Introduction',
    'Related Work',
...
const PATENT: OutputProfile = {
  type: 'patent',
  name: 'Patent Draft',
  audience: 'A patent examiner and a technically trained reader assessing novelty, inventive step and enablement.',
  purpose:
    'Express the research as a protectable technical solution: a technical problem, the solution that solves it, the effects it produces, and how it is implemented.',
  structure: [
    'Technical Field',
...
const TECHNICAL_REPORT: OutputProfile = {
  type: 'technical-report',
  name: 'Technical Report',
  audience: 'Engineers and collaborators who must act on the result rather than cite it.',
  purpose:
    'Document what was done and what was found in enough operational detail that a colleague can reproduce or build on it without asking questions.',
  structure: [
    'Summary',
    'Context and Scope',
    'Approach',
...
const SLIDES: OutputProfile = {
  type: 'slides',
  name: 'Research Presentation',
  audience: 'A live audience with limited attention and no ability to re-read.',
  purpose:
    'Carry one argument through the talk: what problem, why existing answers fail, what was done, what was found, what it means.',
  structure: [
    'Title',
    'Motivation / Problem',
...
/** 第一版实现的四个 Profile（§6）。 */
export const OUTPUT_PROFILES: Record<OutputType, OutputProfile> = {
  paper: PAPER,
  patent: PATENT,
...
/** 取一个 Profile。 */
export function getOutputProfile(type: OutputType): OutputProfile {
