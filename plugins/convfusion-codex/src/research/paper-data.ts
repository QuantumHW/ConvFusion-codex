...
export const PAPER_STATUSES: readonly PaperStatus[] = ['draft', 'evolving', 'frozen', 'archived', 'submitted']
...
export interface RevisionProposal {
  ...
  resolved?: { at: string; by: 'user' | 'agent'; fromVersion: string; toVersion: string; note?: string }
}

/* ════════════════════════════════════════════════════════════════════════
 * Evolution Event（§10 / §29）
 * ════════════════════════════════════════════════════════════════════════ */
 ...
 */
export type PaperMaturityDimension =
  | 'Problem'
  | 'Literature'
  | 'Innovation'
  | 'Method'
...
export const PAPER_MATURITY_DIMENSIONS: readonly PaperMaturityDimension[] = [
  'Problem',
  'Literature',
  'Innovation',
  'Method',
...
export const PAPER_MATURITY_LEVELS: readonly PaperMaturityLevel[] = [
  'Unknown',
  'Weak',
  'Emerging',
  'Strong',
 ...
 * 因此只作为检查依据，不阻断任何操作。
 */
export const REQUIRED_PAPER_SECTIONS: readonly string[] = [
  'Abstract',
  'Introduction',
  'Related Work',
  'Method',
